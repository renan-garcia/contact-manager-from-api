define('app',['exports', './web-api'], function (exports, _webApi) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: '', moduleId: 'no-selection', name: 'select', title: 'Select' }, { route: 'contacts/:id', moduleId: 'contact-detail', name: 'contacts' }, { route: '', moduleId: 'contact-create', name: 'create' }]);
...
define('contact-create',['exports', 'aurelia-event-aggregator', './web-api', 'aurelia-router', './messages', './utility'], function (exports, _aureliaEventAggregator, _webApi, _aureliaRouter, _messages, _utility) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.ContactCreate = undefined;
  ...
  var ContactCreate = exports.ContactCreate = (_temp = _class = function () {
    ContactCreate.inject = function inject() {
      return [_aureliaRouter.Router];
    };

    function ContactCreate(api, ea, router) {
    ...
    ContactCreate.prototype.activate = function activate(params, routeConfig) {
      var _this = this;

      this.routeConfig = routeConfig;
      this.routeConfig = routeConfig;

      return this.api.getContactForCreate().then(function (contact) {
        _this.contact = contact;
        _this.routeConfig.navModel.setTitle("Create contact");
        _this.originalContact = JSON.parse(JSON.stringify(contact));
        _this.ea.publish(new _messages.ContactViewed(_this.contact));
      });
    };

    ContactCreate.prototype.create = function create() {
      var _this2 = this;

      this.api.createContact(this.contact).then(function (contact) {
        _this2.contact = contact;
        _this2.ea.publish(new _messages.ContactCreated(_this2.contact));
      });
    };

    ContactCreate.prototype.canDeactivate = function canDeactivate() {
...
define('contact-list',['exports', 'aurelia-event-aggregator', './web-api', './messages'], function (exports, _aureliaEventAggregator, _webApi, _messages) {
  ...
  var ContactList = exports.ContactList = (_temp = _class = function () {
    ...
    function ContactList(api, ea) {
      ...
      ea.subscribe(_messages.ContactCreated, function (msg) {
        var contact = jQuery.extend({}, msg.contact);
...
define('messages',["exports"], function (exports) {
  ...
  var ContactCreated = exports.ContactCreated = function ContactCreated(contact) {
    _classCallCheck(this, ContactCreated);
  ...
  var WebAPI = exports.WebAPI = function () {
    ...
    WebAPI.prototype.getContactList = function getContactList() {
      ...
      return new Promise(function (resolve, reject) {
        client.fetch('http://localhost:3000/contacts').then(function (response) {
          return response.json();
        }).then(function (response) {
          var results = response.map(function (x) {
            return {
              id: x.id,
    ...
    WebAPI.prototype.getContactForCreate = function getContactForCreate() {
      var _this2 = this;
    ...
    WebAPI.prototype.getContactDetails = function getContactDetails(id) {
      ...
      this.isRequesting = true;
      return new Promise(function (resolve, reject) {
        client.fetch('http://localhost:3000/contacts/' + id).then(function (response) {
          return response.json();
        }).then(function (response) {
          var result = {
            id: response.id,
    ...
    WebAPI.prototype.createContact = function createContact(contact) {
      var _this4 = this;
